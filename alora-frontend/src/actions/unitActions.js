...
export const listUnits = () => async (dispatch) => {
    try {
        ...
        // Dispatches the action (with type UNIT_LIST_SUCCESS) when the API call is successful
        dispatch({
        ...
        // Dispatches the action (with type UNIT_LIST_FAILURE) when there's an error
        dispatch({
