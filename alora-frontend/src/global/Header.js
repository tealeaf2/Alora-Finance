              ...
              <Link to="/lessons/main">
                ...
                <button
                  className={`sm:flex App-header-sections-button App-header-sections-button1 ${
                    location.pathname === "/lessons/main" ? "button1-active" : ""
                  }`}
                >
                  Lessons
                </button>
          ...
          <ul className="App-header-sections flex tems-center">
            <li>
              <Link to="/teacher/lessons/main">
                <button
                  className={`sm:flex App-header-sections-button App-header-sections-button1 ${
                    location.pathname === "/teacher/lessons/main" ? "button1-active" : ""
                  }`}
                >
                  Lessons
                </button>
            ...
            <li>
              <Link to="/teacher/class">
                <button
                  className={`sm:flex App-header-sections-button App-header-sections-button2 ${
                    location.pathname === "/teacher/class" ? "button2-active" : ""
                  }`}
                >
                  Class
                </button>
            ...
            <li>
              <Link to="/teacher/profile">
                <button
                  className={`sm:flex App-header-sections-button App-header-sections-button4 ${
                    location.pathname === "/teacher/profile" ? "button4-active" : ""
                  }`}
                >
                  Profile
                </button>
